...
export const CMDK_SELECT_HANDLER: InjectionKey<(item: CommandItemData) => void> = Symbol('cmdk-select-handler')
export const CMDK_ITEM_INDEX_MAP: InjectionKey<() => Map<string, number>> = Symbol('cmdk-item-index-map')
