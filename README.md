<p align="center">
  <img src="https://img.shields.io/npm/v/vue-cmdk?color=blue&label=version" alt="npm">
...
```ts
import { useCommandMenu } from 'vue-cmddk'
import type { UseCommandMenuReturn, FilterFn } from 'vue-cmdk'
